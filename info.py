...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002432814464').split()]
# post channel auto post new movie
POST_CHANNELS = list(map(int, (channel.strip() for channel in environ.get('POST_CHANNELS', '-1002432814464').split(','))))
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Alexa_Support')
